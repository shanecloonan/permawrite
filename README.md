...
[![Tests](https://img.shields.io/badge/tests-660_passing-brightgreen)](#status)
...
| **Total** | | **660** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (660 passing tests, ~6 min on a modern machine)
