...
- **Tests for everything.** Every new function, every new state-transition rule, every new error variant gets a test. The repo currently has **1,249** passing workspace tests (13 additional `#[ignore]` nightly/deep harnesses) for a reason.
