...
- [ ] Confirm first green Linux nightly for observer-enabled participant rehearsal smoke (**M2.4.72** / **M2.4.77** / **M2.4.82** auto-dispatch via **RC Validation After CI** on green CI `push` or `workflow_dispatch`; hold follow-up pushes until CI finishes; manual **Nightly** dispatch still available).
