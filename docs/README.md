...
- 💰 [**ECONOMICS.md**](./ECONOMICS.md) — the money. Emission curve, fee split, treasury dynamics, the two-mode (r>0 yield-bearing vs r=0 deflation-funded) endowment model, [§ 12 Arweave durability comparison](./ECONOMICS.md#12-permanence-durability-vs-arweave--is-this-model-more-likely-to-break).
