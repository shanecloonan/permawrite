...
| **B** Protocol/Privacy | **B-148** sixth dual-slash→dual settle (this commit); **B-147** (`97dd712`, CI `#29864361735` GREEN) | *Idle* — next **B-149** sixth asymmetric | After 2 hosts: live **B-32** → **B-44** → full **B-24** |
