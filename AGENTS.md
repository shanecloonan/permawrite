...
**CI gate (2026-07-21):** Lane-1 claiming **B-27 soak refresh** tip~5145 (docs-only while **CI #29833394102** on B-116). **CI #29831106571 GREEN** on B-115. **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
