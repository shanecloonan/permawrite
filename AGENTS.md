...
| **3** Onboarding | **B-15 wave30** (vera last_proven=4479; F45 lag=29; F100) | **B-15** formal JOIN archive assert (claim base: this head) | Human/assert SUMMARY; no Hetzner parallel JOIN | L4 checklist |
...
1. **2026-07-20 — lane 3 — B-15 wave30**: New wallet **vera** faucet permanence **last_proven=4479** (commit `b90c135c`); pin@4443; F45 FAIL lag=29 post B-79 tip-4443; claims 10→11; F100 last_proven before tip_id match. Honor §6. *Observed local work (not staged):* wallets, live-testnet-data, other-lane dirty files.
