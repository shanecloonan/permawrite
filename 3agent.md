...
| --- | --- | --- | --- |
| **A** RC/CI | **CI `#29886131086` GREEN** on B-162; **B-15** PASS | *Idle* — watch B-163 head CI | Do not cancel healthy in_progress |
| **B** Protocol/Privacy | **B-165** CI GREEN; **B-163** (`9ae744ce`) | **B-166** eighth→asymmetric (lane4); **B-167** ring-size fail-closed (lane5) | After B-167: **B-168**; after 2 hosts: live **B-32** |
