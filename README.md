...
[![Tests](https://img.shields.io/badge/tests-592_passing-brightgreen)](#status)
...
| **Total** | | **592** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (592 passing tests, ~6 min on a modern machine)
