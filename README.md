...
[![Tests](https://img.shields.io/badge/tests-644_passing-brightgreen)](#status)
...
| **Total** | | **644** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (644 passing tests, ~6 min on a modern machine)
