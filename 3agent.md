...
| **B** Protocol/Privacy | **B-143** op1 asymmetric→absentee re-slash (this commit); **B-142** (360481f, CI #29859782849 GREEN) | *Idle* — next **B-147** sixth dual-slash | After 2 hosts: live **B-32** → **B-44** → full **B-24** |
