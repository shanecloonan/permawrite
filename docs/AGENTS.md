...
- [x] **F5-P5/B1 (consensus output floor)** — `RingPolicy.min_output_count` = 2 under the uniform-ring tier (derived, no codec change); enforced in `verify_transaction`; closes §B1.
