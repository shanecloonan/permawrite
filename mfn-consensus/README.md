...
**Tests:** 374 passing (151 unit + 223 integration across six `tests/` targets; 20 nightly `#[ignore]`) &nbsp;·&nbsp; **`unsafe`:** forbidden &nbsp;·&nbsp; **Clippy:** `-D warnings` (see `scripts/ci-check`)
