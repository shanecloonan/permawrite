...
**CI gate (2026-08-06):** Claiming **B-271** seventeenth op1 asymmetric->absentee re-slash (docs-only while tip CI `#31127944455` on B-270). Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-270** (`4ccf1b79`, watch tip CI `#31127944455`); **B-266** | **B-271** seventeenth op1 re-slash (claim base: `4ccf1b79`; body ready) | After tip GREEN: land B-271; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-271 | Seventeenth-offense op1 asymmetric then absentee re-slash (early B-24dt) | 4 | **Claimed** (this commit) - elevates B-246; full CI after B-270 tip GREEN |
