...
[![Tests](https://img.shields.io/badge/tests-304_passing-brightgreen)](#status)
...
| **Total** | | **304** | Zero `unsafe`. Zero clippy warnings. |
...
# Run the full workspace test suite (304 tests, ~30s on a modern machine)
