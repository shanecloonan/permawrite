...
**CI gate (2026-07-21):** Landing **B-113** early B-24w (full CI). **CI `#29824883480` GREEN** on B-112 `2adf089`. **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-113** third-offense asymmetric→absentee re-slash (`9ae9618`); **B-112** (`2adf089`, CI `#29824883480` GREEN); **B-111**/**B-110** stack | **B-114** early B-24x third-offense op1 asymmetric→absentee re-slash (claim base: `9ae9618`) | After land: watch CI; live **B-32** still blocked on 2nd host (**B-79**) | Lane 1 CI |
...
| B-113 | Third-offense asymmetric then absentee re-slash while peer settles (early B-24w) | 4 | **Landed** (`9ae9618`); watching CI `#29826982613` |
| B-114 | Third-offense op1 asymmetric then absentee re-slash while peer settles (early B-24x) | 4 | **Doing** (claim base `9ae9618`); B-113 twin |
