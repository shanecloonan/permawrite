...
[![Tests](https://img.shields.io/badge/tests-530_passing-brightgreen)](#status)
...
| **Total** | | **530** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (530 passing tests, ~6 min on a modern machine)
