...
[![Tests](https://img.shields.io/badge/tests-576_passing-brightgreen)](#status)
...
| **Total** | | **576** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (576 passing tests, ~6 min on a modern machine)
