...
| --- | --- | --- | --- |
| **A** RC/CI | Watch B-283 tip CI `#31149496815` | *Idle* - do not cancel | Pin / Nightly |
| **B** Protocol/Privacy | **B-283** (`72522d22`); **B-282** | **B-284** op1 asymmetric (claim base `72522d22`) | After land: empty both-miss; after 2 hosts: live **B-32** |
...
Synced at B-284 claim. Body ready; land after tip CI `#31149496815` GREEN.
