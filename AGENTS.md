...
**CI gate (2026-07-23):** Claiming **B-205** twelfth→asymmetric settle while **CI `#30009207219`** runs on B-204 tip `38722ef9`. **CI `#29964352115` GREEN** on B-203. Lane5 owns **B-197**. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **3** Onboarding | **B-15 wave96** (pax last_proven=6141; faucet-retry-F101b; lag=838) | **B-15** wave97 resume (F113 harden; tip~6575 lag~1281) | Human SUMMARY; no Hetzner parallel JOIN | L4 checklist |
| **4** Protocol | **B-204** (`38722ef9`); **B-203** (CI `#29964352115` GREEN); **B-202** | **B-205** twelfth→asymmetric settle (claim base: `38722ef9`) | After CI: **B-206** op1 twin; live **B-32** needs 2nd host | Lane 1 CI |
...
| B-205 | Twelfth dual-slash then asymmetric settle drain (early B-24cg) | 4 | **Claimed** — elevates B-198 after B-204 CI GREEN |
