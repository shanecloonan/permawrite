...
**Generated (UTC):** 2026-06-29T21:05:26.261Z
...
| Metric | Value |
| --- | ---: |
| Source-like files scanned | 325 |
| Total lines (all scanned source-like files) | 109,748 |
| Non-empty lines | 98,611 |
| UTF-8 bytes (source-like) | 4,432,535 |
| Paths visited (before binary/huge skip) | 353 |
...
| `docs` | 39 | 11,407 | 8,166 |
| `mfn-node` | 34 | 10,657 | 9,860 |
...
| --- | ---: | ---: | ---: | ---: |
| `.rs` | 212 | 89,799 | 83,238 | 3,262,765 |
| `.md` | 54 | 13,853 | 9,825 | 957,327 |
| `.js` | 7 | 1,980 | 1,856 | 64,098 |
| `.sh` | 15 | 1,776 | 1,623 | 57,500 |
