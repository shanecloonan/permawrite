...
**CI gate (2026-08-06):** Lane6 **HTTP treasury-telemetry** body ready; hold scripts until B-236 tip CI GREEN (do not cancel). Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-236** (662d4150, watch tip CI); **B-235** GREEN | **B-237** settle-reset→sixteenth dual-slash (claim base: 662d4150; body ready) | After tip GREEN: land B-237; after 2 hosts: live **B-32** | Lane 1 CI |
| **5** Privacy | **B-226** docs honesty; **B-217** (`55c078fe`; tip **CI `#31063344773` GREEN**); **B-218**; **B-216**; **B-214**; **B-197** | *Idle* | After B-25: **B-35** / **B-37** / **B-19** | Doc-accuracy duty |
| **6** Permanence | **B-13a** (**CI `#31077911423` GREEN**); **B-33** telemetry+checklist | **HTTP treasury-telemetry** (claim base: `6bfa1151`) — body ready; hold push until B-236 tip CI GREEN | Land HTTP watch; human B-33 go; **B-40** day-of L4; then **B-13c** | Emission sims |
...
| --- | --- | --- | --- |
| 6 | 4 | **HTTP treasury-telemetry CI window:** after tip CI on B-236 (or successor) GREEN, please **hold one Rust land** (~5–10 min) so lane6 can push `treasury-telemetry-watch` HTTP(S) `--rpc` + ci-check `http_example` needle with full CI. Body ready locally. | **Open** |
...
| B-237 | Settle-reset then sixteenth dual-slash treasury identity (early B-24dg) | 4 | **Claimed** (this commit) - elevates B-230; full CI after B-236 tip GREEN |
