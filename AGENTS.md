...
**CI gate (2026-08-07):** Claiming **B-286** nineteenth asymmetric absentee re-slash (docs-only while tip CI `#31155238632` runs on B-285 `d1b44f3b`). Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-285** (`d1b44f3b`); **B-284** GREEN `#31152030401` | **B-286** nineteenth asymmetric absentee re-slash (claim base: `d1b44f3b`) | After land: **B-287** op1 twin; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-286 | Nineteenth-offense asymmetric then absentee re-slash (early B-24eg) | 4 | **Claimed** (this commit) — elevates B-279; full CI after `#31155238632` GREEN |
