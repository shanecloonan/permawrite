...
[![Tests](https://img.shields.io/badge/tests-626_passing-brightgreen)](#status)
...
| **Total** | | **626** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (626 passing tests, ~6 min on a modern machine)
