...
**CI gate (2026-08-06):** Claiming **B-275** eighteenth op1 asymmetric settle (docs-only while tip CI `#31132162520` runs on B-274 `fef0ca88`). Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-274** (`fef0ca88`); **B-273** GREEN `#31129713995` | **B-275** eighteenth op1 asymmetric (claim base: `fef0ca88`) | After land: empty both-miss; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-275 | Eighteenth dual-slash then op1 asymmetric settle drain (early B-24dx) | 4 | **Claimed** (this commit) — elevates B-263; full CI after `#31132162520` GREEN |
