...
**CI gate (2026-07-21):** Claiming **B-159** early B-24ba (docs-only while **CI `#29878259419`** runs on B-158 `d5dc6f38`). **CI `#29876590150` GREEN** on B-157. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-158** (`d5dc6f38`/`3df22fd3`, watch CI `#29878259419`); **B-157** (`8d6e8203`, CI `#29876590150` GREEN); **B-156**/**B-155** stack | **B-159** seventh-offense asymmetric→absentee re-slash (claim base: `d5dc6f38`) | After land: **B-160** op1 twin; after 2 hosts + B-15: `b3-multi-op-*.txt` → **B-44** → full **B-24** | Lane 1 CI |
...
| B-158 | Seventh dual-slash then empty both-miss (early B-24az) | 4 | **Landed** (this commit); closes seventh-offense prove matrix {00,01,10,11}; elevates B-151; full CI |
| B-159 | Seventh-offense asymmetric then absentee re-slash (early B-24ba) | 4 | **Claimed** (this commit) — elevates B-152; full CI after `#29878259419` GREEN |
| B-160 | Seventh-offense op1 asymmetric then absentee re-slash (early B-24bb) | 4 | Next after B-159 — elevates B-153; twin of B-159 |
...
1. **2026-07-21 — lane 4 — claim B-159** (this commit): early B-24ba seventh-offense asymmetric→absentee re-slash (elevates B-152) while **CI `#29878259419`** runs on B-158. Claim base `d5dc6f38`. *Observed (not staged):* lane-3 `join-testnet-rehearsal-smoke/`. `[skip ci]`.
