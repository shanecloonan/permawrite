...
**Tests:** 375 passing (151 unit + 224 integration across six `tests/` targets; 23 nightly `#[ignore]`) &nbsp;·&nbsp; **`unsafe`:** forbidden &nbsp;·&nbsp; **Clippy:** `-D warnings` (see `scripts/ci-check`)
