...
//!   — length-prefixed frames, [`network::hello_v1_handshake`], and **M2.3.4** [`network::tcp_connect_hello_v1_handshake`];
//!   **M2.3.3** optional **`serve --p2p-listen`**. [`NetworkConfig`] holds listener/dial defaults for future full gossip.
