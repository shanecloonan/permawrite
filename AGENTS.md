...
**CI gate (2026-07-21):** Lane-1 pin **B-123** via **CI `#29842437172` GREEN** on B-122 `2a98633` (scripts matrix proved soak pin harden). B-124 CI in flight. **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.

| Lane | Done (last landed) | Doing | Next (owner → unit) | Checked by |
| --- | --- | --- | --- | --- |
| **1** RC core | **B-125** soak tip-5202 (`f46a162`); **B-123** (`2a98633` body, CI `#29842437172` GREEN); **B-27** tip-5148; **B-96**; **B-34** | *Idle* | Participant JOIN half after B-15 SUMMARY (lane 3); leave Hetzner/Path A to 7 | CI/Nightly run IDs |
...
| 1 | 7 | **B-125 tip lag:** public tip~5199 vs Path A ckpt max **4851** (lag~348 >> threshold 16). Please Path A republish (B-85/B-100 pattern) so JOIN/F45 can re-pin. B-15-safe probe only from lane1. |
