...
**CI gate (2026-08-06):** Lane6 closing §6 Path A lag via B-15-safe VPS publish (lane7 Idle). B-28-post `83d43b9c` awaits tip CI (zombie `#31123682138`). Lane4 hold **B-263**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **6** Permanence | **B-28-post** (`83d43b9c`); **B-13b** draft; **B-40-d0** | **B-264** Path A tip republish (claim base: `aa7556da`) — close lag §6; B-15-safe | Land jsonl + health; pin B-28-post CI; human B-33 | Emission sims |
...
| 6 | 7 | **Path A lag FAIL:** outside-in tip=16453 ckpt_max=16341 **lag=112** (threshold 8; health_ok). Lane6 applying B-15-safe publish+land (lane7 Idle). Evidence `outside-in-tip-ckpt-lag-20260806T183828Z.txt`. | **Ack** (lane6 applying) |
