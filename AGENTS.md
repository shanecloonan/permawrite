...
**CI gate (2026-07-21):** Claiming **B-150** early B-24ar (docs-only while **CI `#29867927644`** runs on B-149 `bdf31e5`). **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-149** (`bdf31e5`, watch CI `#29867927644`); **B-148** (`cc77d1ff`); **B-147** (`97dd712`); **B-143** stack | **B-150** sixth dual-slash→op1 asymmetric settle (claim base: `bdf31e5`) | After land: sixth empty both-miss (**B-151**); after 2 hosts + B-15: `b3-multi-op-*.txt` → **B-44** → full **B-24** | Lane 1 CI |
...
| B-150 | Sixth dual-slash then op1 asymmetric settle drain (early B-24ar) | 4 | **Claimed** (this commit) — elevates B-131; full CI after `#29867927644` GREEN |
