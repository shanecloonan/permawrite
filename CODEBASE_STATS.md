...
**Generated (UTC):** 2026-05-14T02:50:53.694Z
...
| Total lines (all scanned source-like files) | 47,125 |
| Non-empty lines | 41,265 |
| UTF-8 bytes (source-like) | 2,049,959 |
...
| --- | ---: | ---: | ---: | ---: |
| `.rs` | 70 | 35,616 | 32,860 | 1,333,067 |
| `.md` | 39 | 10,436 | 7,484 | 667,873 |
