...
**CI gate (2026-08-07):** Claiming **B-281** settle-reset->nineteenth dual-slash (docs-only while tip CI `#31142492616` runs on B-280 `160c0e51`). Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-280** (`160c0e51`); **B-279** GREEN `#31140317122` | **B-281** settle-reset nineteenth dual-slash (claim base: `160c0e51`) | After land: nineteenth prove matrix; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-281 | Settle-reset then nineteenth dual-slash treasury identity (early B-24eb) | 4 | **Claimed** (this commit) — elevates B-272; full CI after `#31142492616` GREEN |
| B-282 | Nineteenth dual-slash then dual settle drain (early B-24ec) | 4 | **Next** after B-281; elevates B-273 |
