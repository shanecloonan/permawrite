...
**CI gate (2026-08-14):** Lane7 **B-291** dual-payment live storm (claim). Tip CI `#31848492528` in_progress on B-278 `b1ab1b17` — no Rust push until GREEN. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-288** (`925c9c7b`); **B-287** GREEN `#31161003334` | **B-289** twentieth dual settle (claim base: `925c9c7b`) | **B-290** twentieth asymmetric settle; after 2 hosts: live **B-32** | Lane 1 CI |
