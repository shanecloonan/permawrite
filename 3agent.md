...
| --- | --- | --- | --- |
| **A** RC/CI | Tip CI `#31848492528` **GREEN** on B-278 | *Idle* | Pin / Nightly; watch B-289 tip CI |
| **B** Protocol/Privacy | **B-289** (this commit); **B-288** (`925c9c7b`) | *Idle* | **B-290** twentieth asymmetric settle; do not steal B-291 / B-268b |
...
Synced at B-289 land. Tip CI `#31848492528` **GREEN** on B-278; seat C still owns **B-291**.

| Seat | Done | Doing | Next |
| --- | --- | --- | --- |
| **A** RC/CI | Tip CI `#31848492528` **GREEN** on B-278 | *Idle* | Pin / Nightly; watch B-289 tip CI |
| **B** Protocol/Privacy | **B-289** (this commit); **B-288** (`925c9c7b`) | *Idle* | **B-290** twentieth asymmetric settle; after 2 hosts: live **B-32** |
| **C** Testnet/Onboarding | **B-278** (`b1ab1b17`) | **B-291** dual-payment storm + faucet-ops rotate | **B-42**; 2nd host B-32 |
