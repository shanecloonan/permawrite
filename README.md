...
[![Tests](https://img.shields.io/badge/tests-665_passing-brightgreen)](#status)
...
| **Total** | | **665** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (665 passing tests, ~6 min on a modern machine)
