...
**Generated (UTC):** 2026-06-30T02:41:30.715Z
...
| Total lines (all scanned source-like files) | 113,099 |
| Non-empty lines | 101,631 |
| UTF-8 bytes (source-like) | 4,576,051 |
| Paths visited (before binary/huge skip) | 375 |
...
| --- | ---: | ---: | ---: | ---: |
| `.rs` | 212 | 90,359 | 83,745 | 3,283,328 |
| `.md` | 56 | 14,420 | 10,281 | 992,559 |
