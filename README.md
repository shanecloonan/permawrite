...
[![Tests](https://img.shields.io/badge/tests-606_passing-brightgreen)](#status)
...
| **Total** | | **606** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (606 passing tests, ~6 min on a modern machine)
