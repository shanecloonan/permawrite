...
**CI gate (2026-07-22):** Landing **B-196** after **CI `#29946719956` GREEN** on B-189 (re-proves cancelled B-195 tip). **CI `#29944414883` GREEN** on B-194. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
