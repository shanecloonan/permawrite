...
| **B** Protocol/Privacy | **B-164** (lane5, this commit); **B-161** (`3113229f`); **B-160** (`4b0781a1`) | **B-162** settle-reset→eighth dual-slash (lane4) | After CI: **B-163** eighth→dual settle; live **B-32** needs 2nd host |
