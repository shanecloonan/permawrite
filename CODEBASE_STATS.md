...
**Generated (UTC):** 2026-06-29T15:48:13.819Z
...
| Total lines (all scanned source-like files) | 107,166 |
| Non-empty lines | 96,218 |
| UTF-8 bytes (source-like) | 4,312,837 |
...
| `mfn-cli` | 29 | 13,155 | 12,144 |
| `docs` | 39 | 11,349 | 8,109 |
...
| --- | ---: | ---: | ---: | ---: |
| `.rs` | 212 | 87,885 | 81,455 | 3,176,549 |
| `.md` | 54 | 13,729 | 9,722 | 941,991 |
...
| 1,051 | `mfn-cli/src/wallet_cmd.rs` |
