...
**CI gate (2026-08-07):** Claiming **B-276** eighteenth empty both-miss (docs-only while tip CI `#31135276096` runs on B-275 `e5c27e1c`). Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-275** (`e5c27e1c`); **B-274** GREEN `#31132162520` | **B-276** eighteenth empty both-miss (claim base: `e5c27e1c`) | After land: re-slash pair; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-276 | Eighteenth dual-slash then empty both-miss (early B-24dy) | 4 | **Claimed** (this commit) — elevates B-266; full CI after `#31135276096` GREEN |
