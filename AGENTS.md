...
| **4** Protocol | **B-105** second-slash→asymmetric settle (this commit); **B-104** (`2cc5e6e`, CI `#29808184228` GREEN); **B-103** (`ee760b1`); **B-102**/**B-101**/**B-99**/**B-98**/**B-95**/**B-86** stack | *Idle* — live **B-32** blocked on 2nd host (**B-79** NOT READY) | After 2 hosts + B-15: `b3-multi-op-*.txt` → **B-44** → full **B-24** | Lane 1 CI |
...
| B-105 | Second dual-slash then asymmetric settle drain (early B-24o) | 4 | **Landed** (this commit); B-103 funding + B-95 settle; full CI |
