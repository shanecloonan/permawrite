...
foreach ($n in @("B-127", "B-129", "B-134", "outside-in-tip-ckpt-lag", "never=faucet-http", "path-a-publish", "MFN_CKPT_LAG_THRESHOLD", "EVIDENCE", "auto-archive", "STALENESS", "published_at", "ckpt_entries")) {
