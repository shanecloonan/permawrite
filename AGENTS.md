...
| **4** Protocol | **B-104** second-slash→dual-settle (this commit); **B-103** (`ee760b1`, CI `#29806532117` GREEN); **B-102** (`77ba1fb`); **B-101** (`a2c1637`); **B-99** (`55c3a28`); **B-98**/**B-95**/**B-86**/**B-83**/**B-81**/**B-76**/**B-74**/**B-67**/**B-71**/**B-66**/**B-64**/**B-63** | *Idle* — live **B-32** blocked on 2nd host (**B-79** NOT READY) | After 2 hosts + B-15: `b3-multi-op-*.txt` → **B-44** → full **B-24** | Lane 1 CI |
