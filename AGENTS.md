...
**CI gate (2026-07-22):** Claiming **B-201** eleventh asymmetric→absentee re-slash while **CI `#29957063411`** runs on B-200 tip `74b6ded8`. **CI `#29954425543` GREEN** on B-199. Lane5 owns **B-197**. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **3** Onboarding | **B-15 wave92** (luna last_proven=6094; faucet-F101b; lag=794) | **B-15** wave93+ permanence density | Human SUMMARY; no Hetzner parallel JOIN | L4 checklist |
...
| B-201 | Eleventh-offense asymmetric then absentee re-slash (early B-24cc) | 4 | **Claimed** — elevates B-193 after B-200 CI GREEN |
