...
**CI gate (2026-07-21):** Lane-1 claiming **B-129** tip-ckpt lag auto-evidence (docs-only while **CI `#29847644779`** on B-126 proves B-127). **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
