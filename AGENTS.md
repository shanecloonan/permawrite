...
**CI gate (2026-08-06):** Claiming **B-238** sixteenth dual settle (docs-only while tip CI runs on B-237 b7203e1a). Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-237** (b7203e1a, watch tip CI); **B-236** GREEN | **B-238** sixteenth dual settle (claim base: b7203e1a; body ready) | After tip GREEN: land B-238; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-238 | Sixteenth dual-slash then dual settle drain (early B-24dh) | 4 | **Claimed** (this commit) - elevates B-231; full CI after B-237 tip GREEN |
