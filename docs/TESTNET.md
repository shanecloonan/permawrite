...
For the **ordered internet-facing launch path** (Lane 7), see [`TESTNET_LAUNCH.md`](./TESTNET_LAUNCH.md). Run `launch-status.ps1` / `launch-status.sh` for a read-only posture summary.
