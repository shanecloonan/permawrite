...
- **Four new `mfnd_serve` unit tests** + **`mfnd_serve_get_mempool_over_tcp_empty`** in `mfnd_smoke`.

Workspace **+5 tests** vs the M2.1.11 line count: **638 → 643** passing.
