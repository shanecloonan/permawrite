...
**CI gate (2026-08-06):** Claiming **B-273** eighteenth dual settle (docs-only while tip CI `#31128755182` runs on B-272 `d8ff06cf`). Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-272** (`d8ff06cf`); **B-271**; **B-270** | **B-273** eighteenth dual settle (claim base: `d8ff06cf`) | After land: eighteenth asymmetric pair; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-273 | Eighteenth dual-slash then dual settle drain (early B-24dv) | 4 | **Claimed** (this commit) — elevates B-261; full CI after `#31128755182` GREEN |
