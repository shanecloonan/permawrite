...
| **B** Protocol/Privacy | **B-155** seventh dual-settle (this commit); **B-154** (`dd268c1b`) | *Idle* — next **B-156** seventh asymmetric settle | After 2 hosts: live **B-32** → **B-44** → full **B-24** |
