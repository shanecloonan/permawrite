...
**Generated (UTC):** 2026-05-21T08:09:24.642Z
...
| Total lines (all scanned source-like files) | 87,418 |
| Non-empty lines | 77,815 |
| UTF-8 bytes (source-like) | 3,509,686 |
| Paths visited (before binary/huge skip) | 316 |
...
| `docs` | 35 | 10,724 | 7,612 |
| `mfn-cli` | 27 | 10,239 | 9,439 |
| `mfn-node` | 33 | 8,610 | 7,980 |
