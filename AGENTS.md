...
| **3** Onboarding | **B-144** Windows JOIN python3 resolve (`cc79bfe`); **B-15 wave58** | **B-15** formal JOIN (observer sync b15-fresh; claim base: `d96d8b0`) | Assert SUMMARY PASS after tip catch-up; re-pin ckpt **5290** | L4 checklist |
