...
| **B** Protocol/Privacy | **B-201** (`3f80e939`) | **B-202** eleventh op1 asymmetric→absentee re-slash (claim base: `3f80e939`) | After CI: settle-reset→twelfth; live **B-32** needs 2nd host |
| **C** Testnet/Onboarding | **B-15** wave94 nash@6113 PASS | wave95+ density | No parallel Hetzner JOIN |
