...
Synced at lane7 B-229 VPS apply CLOSE. Lane4 keeps B-242. Watch tip CI `#31102959528` on B-241.
...
| **C** Testnet/Onboarding | **B-229 VPS apply** (proxy+frontend; tip~16290) | wave115+ density / Path A | JOIN SUMMARY; **B-42** invite-load |
