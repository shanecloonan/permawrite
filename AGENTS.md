...
**CI gate (2026-08-05):** **B-217** ring-floor wording parity landed (`55c078fe`); tip CI `#31063344773` (watch). **B-226** docs honesty landed (this commit; `[skip ci]`). Lane4 **B-225** claim holds Rust until tip GREEN. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **5** Privacy | **B-226** docs honesty (claim-disabled / ring-16 WASM / F7 fail-closed); **B-217** (`55c078fe`); **B-218**; **B-216**; **B-214**; **B-197** | *Idle* — watch CI `#31063344773` | After B-25: **B-35** / **B-37** / **B-19** | Doc-accuracy duty |
...
| B-217 | WASM/CLI/wallet ring-floor error wording parity (wallet/consensus floor) | 5 | **Landed** (`55c078fe`); elevates B-167/B-182; watch CI `#31063344773` |
