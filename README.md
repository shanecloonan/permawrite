...
[![Tests](https://img.shields.io/badge/tests-620_passing-brightgreen)](#status)
...
| **Total** | | **620** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (620 passing tests, ~6 min on a modern machine)
