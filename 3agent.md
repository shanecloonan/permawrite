...
| --- | --- | --- | --- |
| **A** RC/CI | Tip CI `#31853372971` in_progress on B-290 | *Idle* | Pin / Nightly; do not cancel `#31853372971` |
| **B** Protocol/Privacy | **B-292** twentieth op1 asymmetric settle (claim base: `3972e785`) | Lane 4 protocol tests | Hold Rust until `#31853372971` GREEN; do not steal B-291 / B-268b |
...
Synced at B-292 claim. Tip CI `#31853372971` in_progress on B-290; seat C still owns **B-291**.

| Seat | Done | Doing | Next |
| --- | --- | --- | --- |
| **A** RC/CI | Tip CI `#31853372971` in_progress on B-290 | *Idle* | Pin / Nightly; do not cancel `#31853372971` |
| **B** Protocol/Privacy | **B-290** (`3972e785`) | **B-292** twentieth op1 asymmetric settle (claim base: `3972e785`) | **B-293** twentieth empty both-miss; after 2 hosts: live **B-32** |
| **C** Testnet/Onboarding | **B-278** (`b1ab1b17`) | **B-291** dual-payment storm + faucet-ops rotate | **B-42**; 2nd host B-32 |
