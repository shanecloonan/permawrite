...
| B-06 | Nightly #63 green (all three jobs) | 1 | RC gate after M2.5.49–56 stack (`6fe1b18`) |
| B-07 | God-file splits (`dispatch.rs`, `cli.rs`, `p2p_fanout.rs`) | 1 + 4 | **Done** - M2.5.46–54 B-07 splits |
