...
| **4** Protocol | **B-111** third-slash→op1 asymmetric settle (this commit); **B-110** (`be3e80a`, CI `#29820501612` GREEN); **B-109** (`f93b02d`); **B-108**/**B-107**/**B-106**/**B-105**/**B-104**/**B-103** stack | *Idle* — live **B-32** blocked on 2nd host (**B-79** NOT READY) | After 2 hosts + B-15: `b3-multi-op-*.txt` → **B-44** → full **B-24** | Lane 1 CI |
...
| B-111 | Third dual-slash then op1 asymmetric settle drain (early B-24u) | 4 | **Landed** (this commit); B-110 twin; full CI |
