...
| **4** Protocol | **B-113** third-offense asymmetric→absentee re-slash (this commit); **B-112** (`2adf089`, CI `#29824883480` GREEN); **B-111** (`c705c77`); **B-110**/**B-109**/**B-108** third-offense stack | *Idle* — live **B-32** blocked on 2nd host (**B-79** NOT READY) | After 2 hosts + B-15: `b3-multi-op-*.txt` → **B-44** → full **B-24** | Lane 1 CI |
...
| B-113 | Third-offense asymmetric then absentee re-slash while peer settles (early B-24w) | 4 | **Landed** (this commit); B-101 path on B-108 arc; full CI |
