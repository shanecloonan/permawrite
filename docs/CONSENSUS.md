...
- **`tests/integration.rs` (Agent 1 legacy mixed integration, `ba04799`)** — `legacy_mixed_clsag_fee_and_storage_proof_at_genesis_plus_block1` proves legacy CLSAG fee + SPoRA forward-apply with treasury identity in a real block flow.
