...
- [ ] Nightly #63 all three jobs green after M2.5.50 (B-06; Nightly #62 FAIL ~16.3m on `3a1f213`).
...
- [ ] Nightly #63 participant + observer PASS (B-06).
...
- [ ] Idle - monitor Nightly #63 on `main`.
...
- [ ] B-06 - Nightly #63 all three jobs green after M2.5.50 (lane 1 RC gate).
...
| B-06 | Nightly #63 green | 1 | After M2.5.50 (Nightly #62 FAIL on `3a1f213`) |
