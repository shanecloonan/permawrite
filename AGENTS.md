...
**CI gate (2026-07-22):** Landing **B-192** after **CI `#29936920636` GREEN** on B-191 tip `1baee23e`. Closes tenth prove matrix. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-192** tenth empty both-miss (this commit); **B-191** (`1baee23e`, CI `#29936920636` GREEN); **B-190** | *Idle* | **B-193** tenth asymmetric→absentee re-slash; live **B-32** needs 2nd host | Lane 1 CI |
