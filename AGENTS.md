...
| **4** Protocol | **B-106** second-slash→op1 asymmetric settle (this commit); **B-105** (`357b395`, CI `#29810031256` GREEN); **B-104** (`2cc5e6e`); **B-103**/**B-102**/**B-101**/**B-99**/**B-98**/**B-95**/**B-86** stack | **B-107** early B-24q second-slash→empty both-miss (next; claim base: this head) | After B-107: live **B-32** still blocked on 2nd host (**B-79**) | Lane 1 CI |
...
| B-107 | Second dual-slash then empty both-miss (early B-24q) | 4 | **Next** — closes second-offense prove matrix {00,01,10,11} |
