...
[![Tests](https://img.shields.io/badge/tests-611_passing-brightgreen)](#status)
...
| **Total** | | **611** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (611 passing tests, ~6 min on a modern machine)
