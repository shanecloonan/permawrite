...
**CI gate (2026-08-06):** **B-13a** subsidy-bps-1000 sims landing (this commit). **CI `#31071345155` GREEN** on B-231. Lane4 **B-232** may land next. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-231** (b0e260c, watch tip CI); **B-230** GREEN | **B-232** fifteenth→asymmetric settle (claim base: b0e260c; body ready) | After tip GREEN: land B-232; after 2 hosts: live **B-32** | Lane 1 CI |
| **5** Privacy | **B-226** docs honesty; **B-217** (`55c078fe`; tip **CI `#31063344773` GREEN**); **B-218**; **B-216**; **B-214**; **B-197** | *Idle* | After B-25: **B-35** / **B-37** / **B-19** | Doc-accuracy duty |
| **6** Permanence | **B-13a** (this commit; 256-block @1000 + fee-drought); F6 telemetry (`0d1b9ec`) | *Idle* | **B-33** human checklist; **B-40** day-of L4; then **B-13b/c** | Emission sims |
...
| B-13a | Emission/treasury sims at `1000` bps in default CI | 6 | **Landed** (this commit) — 256-block identity + fee-drought backstop; genesis stays `0` |
...
1. **2026-08-05 — lane 4 — claim B-232** (this commit): early B-24db fifteenth→asymmetric settle while tip CI runs on B-231 b0e260c. Claim base b0e260c. Body ready locally. [skip ci].
