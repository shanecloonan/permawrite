...
**Generated (UTC):** 2026-05-14T21:02:32.427Z
...
| Total lines (all scanned source-like files) | 49,298 |
| Non-empty lines | 43,212 |
| UTF-8 bytes (source-like) | 2,147,607 |
...
| --- | ---: | ---: | ---: | ---: |
| `.rs` | 70 | 37,506 | 34,623 | 1,405,781 |
| `.md` | 39 | 10,665 | 7,615 | 691,238 |
...
| 1,509 | `docs/ROADMAP.md` |
| 1,499 | `mfn-light/src/chain.rs` |
| 1,394 | `mfn-node/src/mfnd_serve.rs` |
...
| 764 | `mfn-node/tests/mfnd_smoke.rs` |
