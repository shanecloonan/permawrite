...
**Generated (UTC):** 2026-05-12T17:23:41.062Z
...
| Total lines (all scanned source-like files) | 21,868 |
| Non-empty lines | 18,739 |
| UTF-8 bytes (source-like) | 890,101 |
...
| --- | ---: | ---: | ---: | ---: |
| `.rs` | 37 | 15,586 | 14,293 | 562,026 |
| `.md` | 20 | 5,323 | 3,621 | 282,285 |
