...
**CI gate (2026-07-22):** Claiming **B-194** tenth op1 asymmetric→absentee re-slash while **CI `#29942162752`** runs on B-193 tip `2dd978ed`. **CI `#29939450769` GREEN** on B-192. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-193** (`2dd978ed`); **B-192** (CI `#29939450769` GREEN); **B-191** | **B-194** tenth op1 asymmetric→absentee re-slash (claim base: `2dd978ed`) | After CI: settle-reset→eleventh; live **B-32** needs 2nd host | Lane 1 CI |
...
| B-194 | Tenth-offense op1 asymmetric then absentee re-slash (early B-24bw) | 4 | **Claimed** — B-193 op1 twin after B-193 CI GREEN |
