...
**CI gate (2026-07-21):** Claiming **B-126** early B-24ah (docs-only while **CI `#29844848474`** runs on B-124 `73ab34a`). **CI `#29842437172` GREEN** on B-122. **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
