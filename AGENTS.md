...
**CI gate (2026-08-05):** Claiming **B-231** fifteenth→dual settle (docs-only while tip CI runs on B-230 `fb2e609d`). **CI `#31068279807` GREEN** on B-228. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-230** (`fb2e609d`, watch tip CI); **B-228** GREEN | **B-231** fifteenth→dual settle (claim base: `fb2e609d`; body ready) | After tip GREEN: land B-231; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-230 | Settle-reset then fifteenth dual-slash treasury identity (early B-24cz) | 4 | **Landed** (this commit); elevates B-221; full CI |
| B-231 | Fifteenth dual-slash then dual settle drain (early B-24da) | 4 | **Claimed** (this commit) — elevates B-222; full CI after B-230 tip GREEN |
