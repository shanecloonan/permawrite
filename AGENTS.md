...
| --- | --- | --- | --- | --- |
| **1** RC core | **B-133** soak tip-5285 (`62357ae`); **B-129** (`7e2afb8`); **B-127** (`981dfd1`, CI `#29847644779` GREEN); **B-125** (`f46a162`); **B-123**; **B-96**; **B-34** | *Idle* | Participant JOIN half after B-15 SUMMARY (lane 3); Path A republish = lane 7 (§6) | CI/Nightly run IDs |
