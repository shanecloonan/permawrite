...
**CI gate (2026-07-21):** Landing **B-134** Path A staleness + §8 repair (`[skip ci]` — do not cancel `#29854607541` on B-131). **Nightly `#29854540235` GREEN**. **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.

| Lane | Done (last landed) | Doing | Next (owner → unit) | Checked by |
| --- | --- | --- | --- | --- |
| **1** RC core | **B-134** Path A staleness + §8 repair (this commit); **B-133** (`62357ae`); **B-129** (`7e2afb8`); **B-127** (`981dfd1`); **B-125**; **B-96**; **B-34** | *Idle* | Participant JOIN half after B-15 SUMMARY (lane 3); Path A republish = lane 7 (§6) | CI/Nightly run IDs |
...
| B-134 | Tip-ckpt lag Path A staleness fields + §8 board repair | 1 | **Landed** (this commit) — STALENESS line; tip=5287 lag=436; §8 header repaired |
