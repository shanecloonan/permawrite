...
| --- | --- | --- | --- | --- |
| **1** RC core | **B-134** Path A staleness + §8 repair (`04295ea`); **B-133** (`62357ae`); **B-129** (`7e2afb8`); **B-127** (`981dfd1`); **B-125**; **B-96**; **B-34** | *Idle* | Participant JOIN half after B-15 SUMMARY (lane 3); Path A republish = lane 7 (§6) | CI/Nightly run IDs |
