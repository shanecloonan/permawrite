...
**CI gate (2026-07-21):** Landing **B-145** tall-tip bootstrap snapshot timeout (`[skip ci]` — do not cancel B-132 CI `#29857236769`). Seat C **B-15** JOIN re-run next. **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
