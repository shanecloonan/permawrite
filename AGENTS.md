...
| **3** Onboarding | **B-15 wave29** (uma last_proven=4466; F99 pin@4400) | **B-15** formal JOIN archive assert (claim base: this head) | Human/assert SUMMARY; no Hetzner parallel JOIN | L4 checklist |
