...
| Wallet | [`ClaimingIdentity`](../mfn-wallet/src/claiming.rs), [`build_storage_upload_with_authorship`](../mfn-wallet/src/upload.rs) / CLI `wallet upload --message` (bound claims only; [`Wallet::publish_claim_tx`](../mfn-wallet/src/wallet.rs) hard-refuses `StandaloneAuthorshipClaimDisabled`) |
