...
- `mfn-net::serve` unit tests — gap-triggered catch-up peer selection skips the node's own P2P listen address, dedupes recovery peers, and caps recovery dials after self-skip/quarantine-filtered peer selection before spawning.
