...
**CI gate (2026-08-05):** Landing **B-224** fourteenth op1 asymmetric settle. **CI `#31059769879` GREEN** on B-223 tip `0559cc6a` (leak revert). Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-224** (this commit); **B-223** (CI `#31059769879` GREEN); **B-222** | *Idle* — next **B-225** fourteenth empty both-miss | After land: fourteenth re-slash pair; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-225 | Fourteenth dual-slash then empty both-miss (early B-24cw) | 4 | Next after B-224 CI GREEN — closes fourteenth prove matrix |
