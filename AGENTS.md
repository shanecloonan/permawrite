...
**CI gate (2026-07-23):** Claiming **B-221** settle-reset→fourteenth dual-slash (docs-only while tip CI `#30046947892` runs on B-220 `fd10ca89`). **CI `#30044629551` GREEN** on B-219. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-220** (`fd10ca89`, watch CI `#30046947892`); **B-219** (CI `#30044629551` GREEN) | **B-221** settle-reset→fourteenth dual-slash (claim base: `fd10ca89`) | After land: fourteenth dual settle; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-221 | Settle-reset then fourteenth dual-slash treasury identity (early B-24cs) | 4 | **Claimed** (this commit) — elevates B-210; full CI after `#30046947892` GREEN |
