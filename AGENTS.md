...
**CI gate (2026-08-06):** Landing **B-275** eighteenth op1 asymmetric settle. Tip CI `#31132162520` **GREEN** on B-274. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-275** (this commit); **B-274** GREEN `#31132162520`; **B-273** | *Idle* | **B-276** eighteenth empty both-miss; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-276 | Eighteenth dual-slash then empty both-miss (early B-24dy) | 4 | **Next** after B-275; elevates B-266 |
