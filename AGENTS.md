...
**CI gate (2026-07-21):** Claiming **B-124** early B-24ag (docs-only while **CI `#29842437172`** runs on B-122 `2a98633`). **CI `#29839631308` GREEN** on B-121. **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
