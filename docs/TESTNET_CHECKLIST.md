...
- [ ] Confirm first green Linux nightly for observer-enabled participant rehearsal smoke (**M2.4.72**).
...
- [ ] Capture Linux 30s-slot soak evidence with hub lifetime past height 10 (**M2.4.73** follow-up).
