...
[![Tests](https://img.shields.io/badge/tests-652_passing-brightgreen)](#status)
...
| **Total** | | **652** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (652 passing tests, ~6 min on a modern machine)
