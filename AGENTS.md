...
**CI gate (2026-08-06):** Claiming **B-237** settle-reset->sixteenth dual-slash (docs-only while tip CI runs on B-236). **CI #31084733657 GREEN** on B-235. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-236** (c0b59b8e/662d4150, watch tip CI); **B-235** GREEN | **B-237** settle-reset->sixteenth dual-slash (claim base: c0b59b8e; body ready) | After tip GREEN: land B-237; after 2 hosts: live **B-32** | Lane 1 CI |
