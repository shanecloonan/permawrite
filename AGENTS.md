...
**CI gate (2026-08-14):** Landing **B-288** settle-reset twentieth dual-slash. Tip CI `#31161003334` **GREEN** on B-287 `f9b734dc`. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-288** (this commit); **B-287** GREEN `#31161003334`; **B-286** | *Idle* | **B-289** twentieth dual settle; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-289 | Twentieth dual-slash then dual settle drain (early B-24ej) | 4 | **Next** after B-288; elevates B-282 |
...
1. **2026-08-14 - lane 4 - B-288 settle-reset->twentieth dual-slash** (this commit): early B-24ei `b288_b5_settle_reset_then_twentieth_dual_slash_treasury_identity`; local exact PASS. Tip CI `#31161003334` **GREEN** on B-287. Elevates B-281. Full CI (no skip). Next: **B-289** twentieth dual settle. Still blocked on 2nd host for live **B-32**. *Observed (not staged):* mfn-wallet/tests/tx_storm.rs; rc-audit-dry-run json.
