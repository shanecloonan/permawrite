...
[![Tests](https://img.shields.io/badge/tests-588_passing-brightgreen)](#status)
...
| **Total** | | **588** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (588 passing tests, ~6 min on a modern machine)
