...
[![Tests](https://img.shields.io/badge/tests-558_passing-brightgreen)](#status)
...
| **Total** | | **558** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (558 passing tests, ~6 min on a modern machine)
