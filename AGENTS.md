...
**CI gate (2026-07-21):** Landing **B-105** early B-24o (full CI). **CI `#29808184228` GREEN** on B-104 `2cc5e6e`. **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-105** second-slash→asymmetric settle (`357b395`); **B-104** (`2cc5e6e`, CI `#29808184228` GREEN); **B-103** (`ee760b1`); **B-102**/**B-101**/**B-99**/**B-98**/**B-95**/**B-86** stack | **B-106** early B-24p second-slash→op1 asymmetric settle (claim base: `357b395`) | After land: watch CI; live **B-32** still blocked on 2nd host (**B-79**) | Lane 1 CI |
...
| B-105 | Second dual-slash then asymmetric settle drain (early B-24o) | 4 | **Landed** (`357b395`); watching CI `#29810031256` |
| B-106 | Second dual-slash then op1 asymmetric settle drain (early B-24p) | 4 | **Doing** (claim base `357b395`); B-105 twin |
