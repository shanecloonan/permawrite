...
- [ ] Nightly #62 all three jobs green (B-06; CI #638 in flight).
...
- [ ] `release-evidence-refresh-for-head` after green CI + Nightly #62.
...
- [ ] Nightly #62 participant + observer PASS (B-06).
...
- [ ] Idle - monitor Nightly #62 on `main`.
...
- [ ] B-06 - Nightly #62 all three jobs green (lane 1 RC gate).
...
| B-06 | Nightly #62 green on `df8d985` | 1 | M2.5.38 + M2.5.43-45 stack |
