...
**CI gate (2026-07-23):** Landing **B-217** ring-floor wording parity + B-220 rustfmt fix-forward (tip CI `#30046947892` FAIL rustfmt on `fd10ca89`). **CI `#30044629551` GREEN** on B-219. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **3** Onboarding | **B-15 wave113** (gina last_proven=6838; faucet-F101b; lag=1535; post-F115) | **B-15** wave114+ permanence density | Human SUMMARY; no Hetzner parallel JOIN | L4 checklist |
| **4** Protocol | **B-220** (`fd10ca89`, CI `#30046947892` FAIL rustfmt → fix-forward in B-217); **B-219** (CI `#30044629551` GREEN); **B-215** | **B-221** settle-reset→fourteenth dual-slash (claim base: `fd10ca89`) | After land: **B-222** fourteenth→dual settle; after 2 hosts: live **B-32** → **B-44** → full **B-24** | Lane 1 CI |
| **5** Privacy | **B-217** (this commit); **B-218** (`8eaa1af6`); **B-216** (`e350481f`); **B-214**; **B-197** | *Idle* | After B-25: **B-35** / **B-37** / **B-19** | Doc-accuracy duty |
...
| B-221 | Settle-reset then fourteenth dual-slash treasury identity (early B-24cs) | 4 | **Claimed** (this commit) — elevates B-210; full CI after B-220 tip GREEN |
...
| B-217 | WASM/CLI/wallet ring-floor error wording parity (`wallet/consensus floor`) | 5 | **Landed** (this commit) — elevates B-167/B-182; + B-220 rustfmt fix-forward |
