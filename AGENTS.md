...
| **6** | M5.44 512-block combined-inflow sim | **Done** - this commit | B-05 Linux soak (lane 2+6) |
...
- **M5.44** (this commit) — 512-block combined-inflow emission sim in default CI (lane 6).
