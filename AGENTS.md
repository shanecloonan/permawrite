...
**CI gate (2026-07-22):** Claiming **B-190** tenth→asymmetric settle while **CI `#29931611895`** runs on B-188 tip `37369cca`. **CI `#29926146314` GREEN** on B-187; **CI `#29929300995` GREEN** on B-186. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **3** Onboarding | **B-15 wave77** (vela last_proven=5923; faucet-retry-F101b; F112 fix; lag=619) | **B-15** wave78+ permanence density | Human SUMMARY; no Hetzner parallel JOIN | L4 checklist |
| **4** Protocol | **B-188** (`37369cca`); **B-187** (CI `#29926146314` GREEN); **B-184** | **B-190** tenth→asymmetric settle (claim base: `37369cca`) | After CI: **B-191** op1 twin; live **B-32** needs 2nd host | Lane 1 CI |
| **5** Privacy | **B-186** (`94cbfece`; **CI `#29929300995` GREEN**); **B-185** | **B-189** CLI F7 owned-UTXO preflight (claim base: `0f1d040e`) | Land after tip CI `#29931611895` GREEN; After B-25: **B-35** / **B-37** / **B-19** | Doc-accuracy duty |
...
| B-190 | Tenth dual-slash then asymmetric settle drain (early B-24bs) | 4 | **Claimed** — elevates B-178 after B-188 CI GREEN |
...
1. **2026-07-22 — lane 3 — B-15 wave77**: **vela** faucet-retry-F101b permanence **last_proven=5923** (commit `ef6cc45c`); F112 fix validated (`--message` intact); F45 lag=619; claims 48->49. Honor section 6. *Observed (not staged):* wallets, live-testnet-data*, other-lane dirty.
