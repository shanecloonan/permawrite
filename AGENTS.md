...
| **4** Protocol | **B-154** (`dd268c1b`, watch CI `#29874504154`); **B-153** (`cd3d37ae`, CI `#29872307794` GREEN); **B-152**/**B-151** stack | **B-155** seventh dual-slash→dual settle (claim base: `dd268c1b`) | After land: seventh-offense prove matrix; after 2 hosts: live **B-32** → **B-44** → full **B-24** | Lane 1 CI |
