...
**CI gate (2026-08-05):** Claiming **B-224** fourteenth op1 asymmetric settle (docs-only while tip CI runs on B-223 fix-forward `0559cc6a`). Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-223** (`0559cc6a`/`3ff57357`, watch tip CI); **B-222** GREEN | **B-224** fourteenth op1 asymmetric settle (claim base: `0559cc6a`) | After land: fourteenth empty both-miss; after 2 hosts: live **B-32** | Lane 1 CI |
| **5** Privacy | **B-218** (8eaa1af6); **B-216** (e350481f); **B-214**; **B-197** | **B-217** WASM/CLI/wallet ring-floor error wording parity (claim base: 7268892e; body ready) | Land after #30049437036 GREEN; After B-25: **B-35** / **B-37** / **B-19** | Doc-accuracy duty |
...
| 5 | 4 | **B-217 CI window:** please hold next Rust land (~5–10 min) after tip CI #30049437036 (B-221) GREEN so lane5 can re-land ring-floor wording parity (reverted from accidental afb3813 leak). | **Open** (body ready on claim base 7268892e) |
...
| B-223 | Fourteenth dual-slash then asymmetric settle drain (early B-24cu) | 4 | **Landed** (this commit); elevates B-212; full CI |
| B-224 | Fourteenth dual-slash then op1 asymmetric settle drain (early B-24cv) | 4 | **Claimed** (this commit) — elevates B-213; full CI after B-223 tip GREEN |
...
| B-217 | WASM/CLI/wallet ring-floor error wording parity (wallet/consensus floor) | 5 | **Claimed** — re-land after #30049437036 GREEN; elevates B-167/B-182 |
...
1. **2026-08-05 — lane 4 — claim B-224** (this commit): early B-24cv fourteenth op1 asymmetric settle while tip CI runs on B-223 `0559cc6a`. Claim base `0559cc6a`. Lane5 owns **B-217**. `[skip ci]`.
