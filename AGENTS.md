...
| **6** Permanence | **B-28-post** (this commit); **B-13b** draft; **B-40-d0**; **B-13a-512** GREEN | *Idle* — watch tip CI | Human B-33 go → arm **B-40** on L4 → **B-13c** only after go | Emission sims |
