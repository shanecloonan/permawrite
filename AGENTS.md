...
| **3** Onboarding | B-15 wave4 partial (`e01645a`) | **B-15 full JOIN** (claim base: this head; tip~4031; light-scan slow) | Archive + assert; keep faucet lock; needs lane 7 if P2P/observer regress | L4 checklist |
