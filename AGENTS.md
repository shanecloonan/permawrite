...
**CI gate (2026-07-22):** Claiming **B-175** early B-24bj (docs-only while **CI `#29897006419`** runs on B-173 tip). **CI `#29895397723` GREEN** on B-171. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-173** (`81bf95fe`, watch CI `#29897006419`); **B-171** (CI `#29895397723` GREEN); **B-170** | **B-175** settle-reset→ninth dual-slash (claim base: `81bf95fe`) | After land: ninth prove matrix; after 2 hosts: live **B-32** → **B-44** → full **B-24** | Lane 1 CI |
...
| B-175 | Settle-reset then ninth dual-slash treasury identity (early B-24bj) | 4 | **Claimed** (this commit) — elevates B-162; full CI after `#29897006419` GREEN |
