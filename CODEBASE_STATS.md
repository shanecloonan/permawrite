...
**Generated (UTC):** 2026-06-29T02:18:15.504Z
...
| Total lines (all scanned source-like files) | 99,362 |
| Non-empty lines | 89,125 |
| UTF-8 bytes (source-like) | 4,013,415 |
...
| --- | ---: | ---: | ---: |
| `mfn-consensus` | 58 | 27,137 | 25,379 |
...
| --- | ---: | ---: | ---: | ---: |
| `.rs` | 202 | 81,950 | 75,944 | 2,981,414 |
| `.md` | 52 | 12,985 | 9,149 | 875,668 |
...
| 1,928 | `mfn-consensus/tests/emission_simulation.rs` |
| 1,916 | `mfn-cli/src/cli.rs` |
| 1,871 | `mfn-consensus/tests/validator_finality_evolution.rs` |
