...
**CI gate (2026-08-14):** Claiming **B-288** settle-reset twentieth dual-slash. Tip CI `#31161003334` **GREEN** on B-287 `f9b734dc`. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-287** (`f9b734dc`; **CI `#31161003334` GREEN**); **B-286** GREEN `#31157851198`; **B-285** | **B-288** settle-reset twentieth dual-slash (claim base: `b5a9a096`) | **B-289** twentieth dual settle; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-288 | Settle-reset then twentieth dual-slash treasury identity (early B-24ei) | 4 | **Doing** (this claim); elevates B-281 |
...
1. **2026-08-14 - lane 4 - claim B-288** (this commit): early B-24ei settle-reset->twentieth dual-slash while tip CI `#31161003334` **GREEN** on B-287 `f9b734dc`. Claim base `b5a9a096`. *Observed (not staged):* mfn-wallet/tests/tx_storm.rs; rc-audit-dry-run json. `[skip ci]`.
