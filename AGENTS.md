...
**CI gate (2026-08-05):** **CI `#31069737973` GREEN** on B-230. Landing **B-231** fifteenth→dual settle. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-231** (this commit); **B-230** (`fb2e609d`; **CI `#31069737973` GREEN**); **B-228** GREEN | *Idle* | **B-232** fifteenth→asymmetric settle; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-232 | Fifteenth dual-slash then asymmetric settle drain (early B-24db) | 4 | **Next** — elevates B-223; full CI after B-231 tip GREEN |
