...
**CI gate (2026-07-21):** Claiming **B-163** early B-24bd (docs-only while **CI `#29886131086`** runs on B-162 tip `3b0fd892`). **CI `#29884711182` GREEN** on B-165. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-162** (`3b0fd892`, watch CI `#29886131086`); **B-160**; **B-159**/**B-158** | **B-163** eighth→dual settle (claim base: `3b0fd892`) | After land: eighth prove matrix (asymmetric/op1/empty); after 2 hosts: live **B-32** → **B-44** → full **B-24** | Lane 1 CI |
...
| B-163 | Eighth dual-slash then dual-settle drain (early B-24bd) | 4 | **Claimed** (this commit) — elevates B-155; full CI after `#29886131086` GREEN |
