...
**CI gate (2026-08-14):** Claiming **B-290** twentieth asymmetric settle. Tip CI `#31851127499` in_progress on B-289 `77750721`. Lane7 **B-291** claimed — do not steal / do not cancel tip CI. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-289** (`77750721`; watch CI `#31851127499`); **B-288** (`925c9c7b`) | **B-290** twentieth asymmetric settle (claim base: `77750721`) | **B-292** twentieth op1 asymmetric settle; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-290 | Twentieth dual-slash then asymmetric settle drain (early B-24ek) | 4 | **Doing** (this claim); elevates B-283 |
| B-292 | Twentieth dual-slash then op1 asymmetric settle drain (early B-24el) | 4 | After B-290; elevates B-284 |
...
1. **2026-08-14 - lane 4 - claim B-290** (this commit): early B-24ek twentieth dual-slash then asymmetric settle while tip CI `#31851127499` runs on B-289 `77750721`. Claim base `77750721`. *Observed (not staged):* mfn-wallet/tests/tx_storm.rs; rc-audit-dry-run json. Lane7 **B-291** claimed. `[skip ci]`.
