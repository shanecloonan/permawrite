...
**CI gate (2026-07-21):** Claiming **B-156** early B-24ax (docs-only while **CI `#29876274630`** runs on B-155 tip). **CI `#29874504154` GREEN** on B-154. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-155** (`c3ebb5ab`/`7d3ba35d`, watch CI `#29876274630`); **B-154** (`dd268c1b`, CI `#29874504154` GREEN); **B-153**/**B-152** stack | **B-156** seventh→asymmetric settle (claim base: `c3ebb5ab`) | After land: seventh op1 asymmetric + empty both-miss; after 2 hosts: live **B-32** → **B-44** → full **B-24** | Lane 1 CI |
