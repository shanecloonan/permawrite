...
| Phase | Scope | Status |
| --- | --- | --- |
| **2a** | Inert param + checkpoint v10 + genesis merge + validation | **This commit** |
| **2b** | Wire `MFER` proof frames in `tx.extra`; `apply_block` + mempool verify | Planned |
| **2c** | Wallet upload builds proof; M5 proptests (valid / forged / mixed CLSAG) | Planned |
