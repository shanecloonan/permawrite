...
| --- | --- | --- | --- |
| **A** RC/CI | Watch B-270 tip CI `#31127944455` | *Idle* - do not cancel healthy in_progress | Pin / Nightly |
| **B** Protocol/Privacy | **B-270** (`4ccf1b79`); watch tip CI | **B-271** op1 re-slash (lane4; body ready) | After 2 hosts: live **B-32** |
...
Synced at B-271 claim. Watch tip CI on B-270; body ready for land after GREEN.
