...
| VPS mfnd binary roll (hub+voters) | `bash scripts/public-devnet-v1/vps-roll-mfnd.sh --apply` — **B-49**; rebuild `mfnd`, soften dial/`Wants=`, restart voters then hub; **never** `faucet-http`; after CI GREEN (B-45; +B-48 when on main) |
