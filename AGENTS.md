...
| **4** Protocol | **B-223** (this commit); **B-222** (CI `#30049842728` GREEN); **B-221** | *Idle* — next **B-224** fourteenth op1 asymmetric settle | After land: fourteenth empty + re-slash; after 2 hosts: live **B-32** → **B-44** → full **B-24** | Lane 1 CI |
...
| B-224 | Fourteenth dual-slash then op1 asymmetric settle drain (early B-24cv) | 4 | Next after B-223 CI GREEN — elevates B-213 |
