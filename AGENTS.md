...
**CI gate (2026-08-07):** Landing **B-284** nineteenth op1 asymmetric settle. Tip CI `#31149496815` **GREEN** on B-283. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-284** (this commit); **B-283** GREEN `#31149496815`; **B-282** | *Idle* | **B-285** nineteenth empty both-miss; after 2 hosts: live **B-32** | Lane 1 CI |
