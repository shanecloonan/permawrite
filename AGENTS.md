...
**CI gate (2026-08-06):** Remap seventeenth settle-reset to **B-259** (B-247 is lane7 outside-in). Watch B-246 tip CI #31112318136. **CI #31109005252 GREEN** on B-13a-512. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| B-259 | Settle-reset then seventeenth dual-slash treasury identity (early B-24dn) | 4 | **Claimed** (this commit) - elevates B-237; remapped (B-247=lane7); full CI after B-246 tip GREEN |
