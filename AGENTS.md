...
| **4** Protocol | **B-147** (`97dd712`, watch CI `#29864361735`); **B-143** (`2dec0fd`, CI `#29862082733` GREEN); **B-142** (`360481f`); **B-132** stack | **B-148** sixth-slash→dual settle (claim base: `97dd712`) | After land: sixth-offense asymmetric pair; after 2 hosts + B-15: `b3-multi-op-*.txt` → **B-44** → full **B-24** | Lane 1 CI |
