...
**CI gate (2026-07-22):** Landing **B-183** after **CI `#29912408521` GREEN** on B-181; tip after lane5 B-185 fix-forward. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-183** ninth asymmetric→absentee re-slash (this commit); **B-181** (`9caa7ee4`, CI `#29912408521` GREEN); **B-179** | *Idle* | **B-184** op1 twin; live **B-32** needs 2nd host | Lane 1 CI |
| **5** Privacy | **B-185** F7 + mempool/rpc + rustfmt (this tip); **B-182** (`e7b3e8bf`); **B-180** | *Idle* | After tip CI GREEN: pin; After B-25: **B-35** / **B-37** / **B-19** | Doc-accuracy duty |
