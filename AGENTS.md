...
**CI gate (2026-08-07):** Claiming **B-284** nineteenth op1 asymmetric settle (docs-only while tip CI `#31149496815` runs on B-283 `72522d22`). Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-283** (`72522d22`); **B-282** GREEN `#31147172975` | **B-284** nineteenth op1 asymmetric (claim base: `72522d22`) | After land: empty both-miss; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-284 | Nineteenth dual-slash then op1 asymmetric settle drain (early B-24ee) | 4 | **Claimed** (this commit) — elevates B-275; full CI after `#31149496815` GREEN |
| B-285 | Nineteenth dual-slash then empty both-miss (early B-24ef) | 4 | **Next** after B-284; elevates B-276 |
