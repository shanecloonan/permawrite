...
| **4** Protocol | **B-103** repeated dual-slash 2nd offense (`ee760b1`); **B-102** (`77ba1fb`, CI `#29804886156` GREEN); **B-101** (`a2c1637`); **B-99** (`55c3a28`); **B-98**/**B-95**/**B-86**/**B-83**/**B-81**/**B-76**/**B-74**/**B-67**/**B-71**/**B-66**/**B-64**/**B-63** | **B-104** early B-24n second-slash→dual-settle (claim base: `ee760b1`) | After land: watch CI; live **B-32** still blocked on 2nd host (**B-79**) | Lane 1 CI |
...
| B-103 | Repeated dual-slash second offense treasury identity (early B-24m) | 4 | **Landed** (`ee760b1`); watching CI `#29806532117` |
| B-104 | Second dual-slash then dual-settle drain (early B-24n) | 4 | **Doing** (claim base `ee760b1`); B-103 funding + B-86 settle |
