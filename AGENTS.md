...
| **4** Protocol | **B-114** third-offense op1 asymmetric→absentee re-slash (this commit); **B-113** (`9ae9618`, CI `#29826982613` GREEN); **B-112** (`2adf089`); **B-111**/**B-110**/**B-109**/**B-108** third-offense stack | *Idle* — live **B-32** blocked on 2nd host (**B-79** NOT READY) | After 2 hosts + B-15: `b3-multi-op-*.txt` → **B-44** → full **B-24** | Lane 1 CI |
...
| B-114 | Third-offense op1 asymmetric then absentee re-slash while peer settles (early B-24x) | 4 | **Landed** (this commit); B-113 twin; full CI |
