...
**CI gate (2026-07-21):** Claiming **B-154** early B-24av (docs-only while **CI `#29872307794`** runs on B-152/B-153 tip `cd3d37ae`). **CI `#29870158905` GREEN** on B-151. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-153** (`cd3d37ae`, watch CI `#29872307794`); **B-152**/**B-151**/**B-150** stack | **B-154** settle-reset→seventh dual-slash (claim base: `cd3d37ae`) | After land: seventh-offense prove matrix; after 2 hosts: live **B-32** → **B-44** → full **B-24** | Lane 1 CI |
...
| B-154 | Settle-reset then seventh dual-slash treasury identity (early B-24av) | 4 | **Claimed** (this commit) — elevates B-147; full CI after `#29872307794` GREEN |
