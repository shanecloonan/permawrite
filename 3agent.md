...
Synced at Seat B **B-268f** claim. Tip CI `#31876698322` **in_progress** on B-300 — do not cancel. Nightly `#31861932921` **GREEN**. Seat C tip-22495 stall recover stands.
...
| **B** Protocol/Privacy | **B-300** (`393d508c`); **B-268e** (`13ea7acf`) | **B-268f** apply_block refuse overlay bps>10000 (claim base `393d508c`) | **B-35** pad; no B-13c |
...
2. **CI concurrency:** if GitHub CI is in_progress on main, prefer [skip ci] for docs/ops; never cancel a healthy run. B-300 `#31876698322` in_progress; `#31874878025` rust GREEN / scripts FAIL (Seat A); Nightly `#31861932921` GREEN.
...
3agent — Seat B: Done B-300 inbound hello 3s slot release / Doing B-268f apply overlay fail-closed / Next B-35 pad
