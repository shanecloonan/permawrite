...
| B-266 | Seventeenth dual-slash then empty both-miss (early B-24dr) | 4 | Next after B-263 — elevates B-241; closes seventeenth prove matrix {11,01,10,00} (ID remapped; B-265 = lane6 genesis emission) |
