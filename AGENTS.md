...
**CI gate (2026-07-21):** Claiming **B-134** Path A staleness fields + §8 board repair (docs/scripts while **CI `#29854607541`** on B-131). **CI `#29852461441` GREEN** on B-130. **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.

| Lane | Done (last landed) | Doing | Next (owner → unit) | Checked by |
| --- | --- | --- | --- | --- |
| **1** RC core | **B-133** soak tip-5285 (`62357ae`); **B-129** (`7e2afb8`); **B-127** (`981dfd1`, CI `#29847644779` GREEN); **B-125** (`f46a162`); **B-123**; **B-96**; **B-34** | **B-134** Path A staleness + §8 repair (claim base: `1a66566`) | Participant JOIN half after B-15 SUMMARY (lane 3); Path A republish = lane 7 (§6) | CI/Nightly run IDs |
...
| B-134 | Tip-ckpt lag Path A staleness fields + §8 board repair | 1 | **Claimed** (this commit) — ckpt_entries/published_at; no Path A publish |
