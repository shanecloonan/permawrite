...
| --- | --- | --- | --- |
| **A** RC/CI | **CI `#29876590150` GREEN** on B-157; watch B-158 head CI; **B-15** PASS | *Idle* — watch B-158 | Release-evidence after CI+Nightly GREEN; do not cancel healthy in_progress |
| **B** Protocol/Privacy | **B-158** (`3df22fd3`); **B-50** (`3df22fd3`) | **B-159** (lane4) + **B-161** heavy CLI snapshot timeout (lane5, claim base `65e19cbe`) | After CI: **B-160** op1 twin; live B-50 prove after B-161; live **B-32** needs 2nd host |
