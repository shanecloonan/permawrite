...
[![Tests](https://img.shields.io/badge/tests-635_passing-brightgreen)](#status)
...
| **Total** | | **635** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (635 passing tests, ~6 min on a modern machine)
