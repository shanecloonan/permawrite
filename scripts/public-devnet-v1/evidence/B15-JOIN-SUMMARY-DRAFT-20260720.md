...
**Status:** DRAFT — waves 6–114; hugo@6848 PASS; tip~6848 ckpt=5290 lag=1549; eighty-three proxy-proven.
...
| orin | faucet-retry-F101b | n/a | yes | **6128** (wave95; proxy-prove PASS; F95) |
...
| ivy | faucet-F101b | n/a | yes | **5810** (wave67; proxy-prove PASS; F110; lag>500) |
...
| dax | faucet-F101b | n/a | **no** | FAIL wave110 upload abort (F115 tip_id diverge pre-upload; wipe#4) |
...
| tess | faucet-retry (after 429+600s) | n/a | yes | **4749** (wave53; proxy-prove PASS) |
| sara | faucet | n/a | yes | **4736** (wave52; proxy-prove PASS) |
| rita | faucet-retry (delayed owned=2) | n/a | yes | **4728** (wave51; proxy-prove PASS; F101b) |
| quinn | faucet-retry (after 429+600s) | n/a | yes | **4709** (wave50; proxy-prove PASS) |
...
Fifty-four wallets with public last_proven: heidi/ivan/judy/karl/mike/nina/oscar/patricia/quinn/rose/sam/tina/uma/vera/wendy/xena/zoe/cora/dana/erin/frank/gina/hank/**iris**. Lisa excluded (F88). Runbook: F88b tip_id wait, F89 /faucet, F90 re-scan after receive.
