...
| **B** Protocol/Privacy | **B-143** (`2dec0fd`); fifth-offense re-slash pair closed | **B-147** settle-reset→sixth dual-slash (claim base `2dec0fd`) | After land: sixth-offense prove matrix; after 2 hosts: **B-32** |
