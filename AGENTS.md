...
**CI gate (2026-08-06):** Landing **B-274** eighteenth asymmetric settle. Tip CI `#31129713995` **GREEN** on B-273. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-274** (this commit); **B-273** GREEN `#31129713995`; **B-272** | *Idle* | **B-275** eighteenth op1 asymmetric; after 2 hosts: live **B-32** | Lane 1 CI |
