...
**Generated (UTC):** 2026-05-20T10:45:35.567Z
...
| Total lines (all scanned source-like files) | 78,375 |
| Non-empty lines | 69,484 |
| UTF-8 bytes (source-like) | 3,191,398 |
...
| --- | ---: | ---: | ---: | ---: |
| `.rs` | 173 | 61,727 | 56,898 | 2,228,145 |
| `.md` | 50 | 12,477 | 8,800 | 818,513 |
