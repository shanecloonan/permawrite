...
**CI gate (2026-08-06):** Claiming **B-237** settle-reset→sixteenth dual-slash (docs-only while tip CI runs on B-236 662d4150). **CI `#31084733657` GREEN** on B-235. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
