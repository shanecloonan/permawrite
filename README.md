...
[![Tests](https://img.shields.io/badge/tests-670_passing-brightgreen)](#status)
...
| **Total** | | **670** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (670 passing tests, ~6 min on a modern machine)
