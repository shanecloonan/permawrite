...
| **5** | B3 tail production RNG contract (`production_tx_rng`, frontend source-scan) | **Done** - this commit | B7 Dandelion++ relay (multi-session) |
