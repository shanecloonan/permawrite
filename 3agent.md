...
Synced at Seat B **B-268g** claim. Tip CI `#31879672133` **in_progress** on B-268f — do not cancel. Nightly `#31861932921` **GREEN**. Seat C tip-22495 stall recover stands.
...
| **B** Protocol/Privacy | **B-268f** (`74923cc5`); **B-300** (`393d508c`) | **B-268g** light apply refuse overlay bps>10000 (claim base `74923cc5`) | **B-35** pad; no B-13c |
...
2. **CI concurrency:** if GitHub CI is in_progress on main, prefer [skip ci] for docs/ops; never cancel a healthy run. B-268f `#31879672133` in_progress; `#31876698322` rust GREEN / scripts FAIL (Seat A); Nightly `#31861932921` GREEN.
...
3agent — Seat B: Done B-268f apply_block overlay bps>10000 fail-closed / Doing B-268g light overlay fail-closed / Next B-35 pad
