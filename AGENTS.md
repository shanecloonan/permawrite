...
**CI gate (2026-07-22):** Claiming **B-204** twelfth→dual settle while **CI `#29964352115`** runs on B-203 tip `017b504e`. **CI `#29962531591` GREEN** on B-202. Lane5 owns **B-197**. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-203** (`017b504e`); **B-202** (CI `#29962531591` GREEN); **B-201** | **B-204** twelfth→dual settle (claim base: `017b504e`) | After CI: twelfth asymmetric; live **B-32** needs 2nd host | Lane 1 CI |
...
| B-204 | Twelfth dual-slash then dual settle drain (early B-24cf) | 4 | **Claimed** — elevates B-196 after B-203 CI GREEN |
