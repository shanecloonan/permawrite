...
| **3** Onboarding | **B-15 wave56** (xavier last_proven=4794; faucet; F45 lag=107) | **B-15** wave57+ + formal JOIN archive assert (claim base: this head) | Human/assert SUMMARY; no Hetzner parallel JOIN | L4 checklist |
