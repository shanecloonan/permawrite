...
- [ ] **B-16** — Privacy-doc sync: [`JOIN_TESTNET.md`](./JOIN_TESTNET.md), [`TESTNET.md`](./TESTNET.md), [`PRIVACY.md`](./PRIVACY.md), [`TESTNET_INVITE.md`](./TESTNET_INVITE.md) (+ OPERATORS + wallet/WASM READMEs) match shipped light-scan / checkpoint-log / F7 faucet UX. **Tick only after files are on `main`.**
