...
**CI gate (2026-08-06):** **B-264** Path A tip-16456 landed (lag OK). B-28-post `83d43b9c` still awaits tip CI (zombie `#31123682138`). Lane4 hold **B-263** until tip GREEN. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **6** Permanence | **B-264** Path A tip-16456 (`land` this commit); **B-28-post** (`83d43b9c`); **B-13b** draft; **B-40-d0** | *Idle* — await tip CI GREEN for B-28-post pin; no B-13c | Human **B-33** → arm **B-40** day-of L4; **B-13c** only after go | Emission sims |
