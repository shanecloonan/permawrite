...
**Generated (UTC):** 2026-05-22T05:23:21.732Z
...
| Total lines (all scanned source-like files) | 88,721 |
| Non-empty lines | 79,008 |
| UTF-8 bytes (source-like) | 3,617,861 |
...
| --- | ---: | ---: | ---: | ---: |
| `.rs` | 200 | 71,527 | 65,988 | 2,622,993 |
