...
**CI gate (2026-07-21):** Landing **B-101** early B-24k (full CI). **CI #29801574290 GREEN** on tip 7ee3f66 (B-99+B-96). Prior **CI #29797153366 GREEN** on B-98. **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-101** slash→asymmetric→absentee re-slash (this commit); **B-99** (`7ee3f66`); **B-98** (`8eb586e`, CI `#29797153366` GREEN); **B-95**/**B-86**/**B-83**/**B-81**/**B-76**/**B-74**/**B-67**/**B-71**/**B-66**/**B-64**/**B-63** | **B-32** live pack — blocked on 2nd host (**B-79** NOT READY) | After 2 hosts + B-15: `b3-multi-op-*.txt` → **B-44** → full **B-24** | Lane 1 CI |
...
| B-99 | Slash-funded treasury then empty both-miss (early B-24j) | 4 | **Landed** (`7ee3f66`/`55c3a28`); CI `#29801574290` (watch) |
| B-101 | Slash-funded asymmetric then absentee re-slash while peer settles (early B-24k) | 4 | **Landed** (this commit); window-spaced multi-block; full CI |
