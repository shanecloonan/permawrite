...
**Generated (UTC):** 2026-06-29T21:47:19.382Z
...
| Total lines (all scanned source-like files) | 110,097 |
| Non-empty lines | 98,922 |
| UTF-8 bytes (source-like) | 4,433,689 |
...
| --- | ---: | ---: | ---: | ---: |
| `.rs` | 212 | 89,909 | 83,336 | 3,255,050 |
| `.md` | 54 | 13,880 | 9,847 | 959,574 |
