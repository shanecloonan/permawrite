...
[![Tests](https://img.shields.io/badge/tests-643_passing-brightgreen)](#status)
...
| **Total** | | **643** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (643 passing tests, ~6 min on a modern machine)
