...
**Generated (UTC):** 2026-05-21T07:08:46.405Z
...
| Total lines (all scanned source-like files) | 86,736 |
| Non-empty lines | 77,225 |
| UTF-8 bytes (source-like) | 3,485,542 |
...
| --- | ---: | ---: | ---: | ---: |
| `.rs` | 197 | 69,820 | 64,419 | 2,507,703 |
