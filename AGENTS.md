...
**CI gate (2026-08-07):** Claiming **B-285** nineteenth empty both-miss (docs-only while tip CI `#31152030401` runs on B-284 `a81dfd55`). Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-284** (`a81dfd55`); **B-283** GREEN `#31149496815` | **B-285** nineteenth empty both-miss (claim base: `a81dfd55`) | After land: re-slash pair; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-285 | Nineteenth dual-slash then empty both-miss (early B-24ef) | 4 | **Claimed** (this commit) — elevates B-276; full CI after `#31152030401` GREEN |
| B-286 | Nineteenth-offense asymmetric then absentee re-slash (early B-24eg) | 4 | **Next** after B-285; elevates B-279 |
