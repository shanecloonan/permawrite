...
[![Tests](https://img.shields.io/badge/tests-629_passing-brightgreen)](#status)
...
| **Total** | | **629** | Zero `unsafe`. Zero clippy warnings. Two ignored placeholders/doc examples. |
...
# Run the full workspace test suite (629 passing tests, ~6 min on a modern machine)
