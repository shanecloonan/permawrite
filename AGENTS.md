...
**CI gate (2026-07-21):** Claiming **B-153** early B-24au (docs-only while **CI `#29872169366`** runs on B-152 `7f86b69`). **CI `#29870158905` GREEN** on B-151. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-152** (`7f86b69`, watch CI `#29872169366`); **B-151** (`9d20b008`, CI `#29870158905` GREEN); **B-150** (`6a2c779`); **B-149** stack | **B-153** sixth-offense op1 asymmetric→absentee re-slash (claim base: `7f86b69`) | After land: settle-reset→seventh dual-slash; after 2 hosts + B-15: `b3-multi-op-*.txt` → **B-44** → full **B-24** | Lane 1 CI |
...
| B-151 | Sixth dual-slash then empty both-miss (early B-24as) | 4 | **Landed** (this commit); closes sixth-offense prove matrix {00,01,10,11}; elevates B-132; full CI |
| B-152 | Sixth-offense asymmetric then absentee re-slash (early B-24at) | 4 | **Landed** (this commit); elevates B-142; full CI |
| B-153 | Sixth-offense op1 asymmetric then absentee re-slash (early B-24au) | 4 | **Claimed** (this commit) — B-152 twin; elevates B-143; full CI after `#29872169366` GREEN |
...
1. **2026-07-21 — lane 4 — claim B-153** (this commit): early B-24au sixth-offense op1 asymmetric→absentee re-slash (B-152 twin) while **CI `#29872169366`** runs on B-152. Claim base `7f86b69`. *Observed (not staged):* lane-3 `join-testnet-rehearsal-smoke/`. `[skip ci]`.
