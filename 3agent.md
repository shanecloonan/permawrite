...
Synced at Seat B **B-314** PM19 cold-proof helper. **B-313** `9028debb`. Tip CI `#32578440244` rust **GREEN** / scripts **FAIL**. Nightly `#31861932921` **GREEN**. Lane7 Path A **22565** / last_proven **22560**.
...
| **B** Protocol/Privacy | **B-314** PM19 cold-proof helper (this commit); **B-313** (`9028debb`); **B-312** (`4720c245`); **B-311** (`6c0d4a84`) | *Idle* | **B-306b** + **PM1** enable after B-25 / Path B; **B-20** after B-13c + B-25; **B-44** after B-32; **B-35** still Phase 3; no B-13c |
...
2. **CI concurrency:** if GitHub CI is in_progress on main, prefer [skip ci] for docs/ops; never cancel a healthy run. Tip CI `#32578440244` rust GREEN / scripts FAIL; Nightly `#31861932921` GREEN.
...
3agent — Seat B: Done B-314 PM19 cold-proof helper / Doing idle / Next B-306b + PM1 enable after B-25 / Path B; B-20 after B-13c+B-25; B-44 after B-32 (no B-13c)
