...
**CI gate (2026-07-21):** Landing **B-150** early B-24ar (full CI on tip `6a2c779`; subject mislabeled rustfmt). Watch **CI `#29867968439`**. **CI `#29864361735` GREEN** on B-147. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-150** sixth→op1 asymmetric settle (`6a2c779`, watch CI `#29867968439`; subject mislabeled); **B-149** (`bdf31e5`); **B-148** (`cc77d1ff`); **B-147** stack | *Idle* — next sixth empty both-miss (**B-151**); live **B-32** needs 2nd host | After 2 hosts + B-15: `b3-multi-op-*.txt` → **B-44** → full **B-24** | Lane 1 CI |
...
| B-151 | Sixth dual-slash then empty both-miss (early B-24as) | 4 | Next after B-150 CI GREEN — closes sixth-offense prove matrix |
