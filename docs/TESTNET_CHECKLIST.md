...
- [ ] Confirm first green Linux nightly for observer-enabled participant rehearsal smoke (**M2.4.72** / **M2.4.77** auto-dispatch via **RC Validation After CI** on green CI push; manual **Nightly** dispatch still available).
