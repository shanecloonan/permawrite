...
**CI gate (2026-08-07):** Landing **B-287** nineteenth op1 asymmetric absentee re-slash. Tip CI `#31157851198` **GREEN** on B-286. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-287** (this commit); **B-286** GREEN `#31157851198`; **B-285** | *Idle* | **B-288** settle-reset twentieth dual-slash; after 2 hosts: live **B-32** | Lane 1 CI |
...
1. **2026-08-07 - lane 4 - B-287 nineteenth op1 asymmetric->absentee re-slash** (this commit): early B-24eh `b287_b5_nineteenth_offense_op1_asymmetric_then_absentee_reslash_while_peer_settles`; local exact PASS. Tip CI `#31157851198` **GREEN** on B-286. Elevates B-280; completes nineteenth re-slash pair with B-286. Full CI (no skip). Next: **B-288** settle-reset->twentieth dual-slash. Still blocked on 2nd host for live **B-32**. *Observed (not staged):* mfn-wallet/tests/tx_storm.rs.
