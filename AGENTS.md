...
| **3** Onboarding | **B-15 wave51** (rita last_proven=4728; F101b faucet-retry) | **B-15** formal JOIN archive assert (claim base: this head) | Human/assert SUMMARY; no Hetzner parallel JOIN | L4 checklist |
...
1. **2026-07-20 — lane 3 — B-15 wave51**: **rita** permanence **last_proven=4728** (commit `e5dd4c00`); faucet-retry with **F101b** delayed owned=2; peers skipped; claims 25→26. Honor §6. *Observed local work (not staged):* wallets, live-testnet-data*, other-lane dirty files.
