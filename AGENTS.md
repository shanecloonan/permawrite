...
**CI gate (2026-08-14):** Landing **B-292** twentieth op1 asymmetric settle. Tip CI `#31853372971` **GREEN** on B-290 `3972e785`. Lane7 **B-291** claimed — do not steal. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-292** (this commit); **B-290** GREEN `#31853372971`; **B-289** GREEN `#31851127499` | *Idle* | **B-293** twentieth empty both-miss; after 2 hosts: live **B-32** | Lane 1 CI |
