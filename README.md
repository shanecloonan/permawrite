...
[![Tests](https://img.shields.io/badge/tests-317_passing-brightgreen)](#status)
...
| **Total** | | **317** | Zero `unsafe`. Zero clippy warnings. |
...
# Run the full workspace test suite (317 tests, ~30s on a modern machine)
