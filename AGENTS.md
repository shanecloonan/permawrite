...
**CI gate (2026-08-06):** **B-264** Path A tip-16456 Done. Tip CI `#31126356769` workflow_dispatch on `16fb0583` (covers B-28-post ancestry); zombie `#31123682138` still listed queued (cancel refused). Lane4 hold **B-263** until tip GREEN. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **6** Permanence | **B-264** (`16fb0583` tip-16456); **B-28-post** (`83d43b9c`); **B-13b** draft; **B-40-d0** | *Idle* — watch CI `#31126356769`; no B-13c | Human **B-33** → arm **B-40** day-of L4; **B-13c** only after go | Emission sims |
