...
**CI gate (2026-08-06):** Lane6 **B-40-d0** landed (4bcaf8e2); watch tip CI #31115971810. Lane4 holding **B-259** (do not cancel). **CI #31112318136 GREEN** on B-246. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-246** GREEN #31112318136 | **B-259** body ready - hold until lane6 tip CI #31115971810 GREEN | After GREEN: land B-259; after 2 hosts: live **B-32** | Lane 1 CI |
