...
**CI gate (2026-08-15):** B-268f `#31879672133` **in_progress** — do not cancel. Claiming **B-268g** `[skip ci]`. B-300 `#31876698322` rust/clippy/wasm/audit + all OS tests **GREEN**; scripts FAIL is Seat A. Nightly `#31861932921` **GREEN**. Lane7 tip-22495 stall recover stands. Slash-clone matrix frozen. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-268f** (`74923cc5`); **B-300** (`393d508c`; rust GREEN `#31876698322`) | **B-268g** light apply refuse overlay bps>10000 (claim base: `74923cc5`) | **B-35** pad; after 2 hosts: live **B-32**. No B-297 clone | Lane 1 CI |
...
| B-268g | Light apply refuses overlay `activation_value > 10000` | 4 | **Claimed** (this commit); body after B-268f CI; no B-13c enable |
