...
**CI gate (2026-08-15):** Lane2 `go` requires >=2 bonded genesis operators (this commit, `[skip ci]`). Do **not** cancel B-268b CI `#31867337251`. Tip CI `#31860183965` **GREEN**; Nightly `#31861932921` **GREEN**. Lane6 **B-268b** `ee3739e7`; lane7 **B-42** `bda9a419`. Slash-clone matrix frozen. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
