...
| **7** Testnet launch | **B-138** public-testnet health OK (this commit); **B-137** Path A tip-5290 (`10eedc1`); **B-100**; **B-97** | *Idle* | **B-42** after B-15 PASS; real 2nd host for B-32 | `launch-go-no-go` |
...
| B-138 | Public-testnet health verify after Path A tip-5290 | 7 | **Landed** (this commit) — VPS health OK lag=0; §6 re-pin Ack tip-5290 |
