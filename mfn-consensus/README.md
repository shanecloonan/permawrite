...
- **Emission simulation (M5.0–M5.17)** (`tests/emission_simulation.rs`, 21 tests) — long-run treasury ledger vs `apply_block`, validator CLSAG-fee and mixed fee+proof chains, liveness-slash, combined-inflow, and 32/64-block equivocation combined-inflow ledgers, coinbase decrypt checks; deep sims `#[ignore]` (nightly).
