...
**CI gate (2026-07-21):** Landing **B-115** early B-24y (full CI). **CI `#29829071765` GREEN** on B-114 `e8300b9`. **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-115** second-offense asymmetric→absentee re-slash (this commit); **B-114** (`e8300b9`, CI `#29829071765` GREEN); **B-113** (`9ae9618`); **B-112**/**B-111**/**B-110**/**B-109**/**B-108** stack | *Idle* — live **B-32** blocked on 2nd host (**B-79** NOT READY) | After 2 hosts + B-15: `b3-multi-op-*.txt` → **B-44** → full **B-24** | Lane 1 CI |
...
1. **2026-07-21 — lane 4 — B-115 second-offense asymmetric→absentee re-slash** (this commit): early B-24y `b115_b5_second_offense_asymmetric_then_absentee_reslash_while_peer_settles`; local debug PASS. **CI `#29829071765` GREEN** on B-114. Fills second-offense B-101 gap. Full CI (no skip). Still blocked on 2nd host for live **B-32**.
