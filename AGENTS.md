...
**CI gate (2026-08-14):** Claiming **B-294** twentieth asymmetric re-slash. Tip CI `#31857970110` in_progress on B-293 `054f6332`. Lane7 **B-291** claimed — do not steal / do not cancel tip CI. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-293** (`054f6332`; watch CI `#31857970110`); **B-292** GREEN `#31856003083` | **B-294** twentieth asymmetric re-slash (claim base: `054f6332`) | **B-295** twentieth op1 re-slash; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-294 | Twentieth-offense asymmetric then absentee re-slash (early B-24en) | 4 | **Doing** (this claim); elevates B-286 |
...
1. **2026-08-14 - lane 4 - claim B-294** (this commit): early B-24en twentieth-offense asymmetric then absentee re-slash while tip CI `#31857970110` runs on B-293 `054f6332`. Claim base `054f6332`. *Observed (not staged):* mfn-wallet/tests/tx_storm.rs; rc-audit-dry-run json. Lane7 **B-291** claimed. `[skip ci]`.
