...
**CI gate (2026-07-21):** Claiming **B-116** early B-24z (docs-only while **CI `#29831106571`** runs on B-115 `696d9e8`). **CI `#29829071765` GREEN** on B-114 `e8300b9`. **B-29 CLOSED**. Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-115** (`696d9e8`, watch CI `#29831106571`); **B-114** (`e8300b9`, CI `#29829071765` GREEN); **B-113** (`9ae9618`); **B-112**/**B-111**/**B-110**/**B-109**/**B-108** stack | **B-116** second-offense op1 asymmetric→absentee re-slash (claim base: `ba47f6c`) | After 2 hosts + B-15: `b3-multi-op-*.txt` → **B-44** → full **B-24** | Lane 1 CI |
...
| B-116 | Second-offense op1 asymmetric then absentee re-slash (early B-24z) | 4 | **Claimed** (this commit) — B-115 twin; full CI after `#29831106571` GREEN |
...
1. **2026-07-21 — lane 4 — claim B-116** (this commit): early B-24z second-offense op1 asymmetric→absentee re-slash (B-115 twin) while **CI `#29831106571`** runs on B-115. Claim base `ba47f6c`. `[skip ci]`.
