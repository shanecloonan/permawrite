...
**CI gate (2026-07-23):** Landing **B-222** fourteenth→dual settle (re-proves B-221 + rustfmt tip). After tip GREEN: **hold** for lane5 **B-217** (§6). Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-222** (this commit); **B-221** + rustfmt (`dd22952a`); **B-220** | *Idle* — hold next Rust for lane5 **B-217**; then fourteenth asymmetric | After B-217 window: fourteenth prove matrix; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-222 | Fourteenth dual-slash then dual settle drain (early B-24ct) | 4 | **Landed** (this commit); elevates B-211; full CI |
