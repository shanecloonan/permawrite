...
| --- | --- | --- | --- |
| **A** RC/CI | **CI `#29872307794` GREEN** on B-152/B-153; **B-15** PASS; **B-29 CLOSED** | *Idle* | Release-evidence after CI+Nightly GREEN; do not cancel healthy in_progress |
| **B** Protocol/Privacy | **B-154** (`dd268c1b`, watch CI `#29874504154`); **B-153**/**B-152** (`cd3d37ae`) | **B-155** seventh dual-slash→dual settle (claim base: `dd268c1b`) | After land: **B-156** asymmetric; after 2 hosts: **B-32** |
