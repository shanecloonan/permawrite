...
**CI gate (2026-07-22):** Landing **B-190** after **CI `#29931611895` GREEN** on B-188 tip `37369cca`. Tenth prove matrix in progress. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-190** tenth→asymmetric settle (this commit); **B-188** (`37369cca`, CI `#29931611895` GREEN); **B-187** | *Idle* | **B-191** tenth op1 asymmetric; live **B-32** needs 2nd host | Lane 1 CI |
