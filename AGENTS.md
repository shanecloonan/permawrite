...
**CI gate (2026-07-22):** Claiming **B-181** early B-24bn while **CI `#29908001364`** runs on B-179 tip `2afc7302`. **CI `#29905438517` GREEN** on B-178. **B-15 JOIN PASS**. **B-29 CLOSED**. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| B-180 | Wallet upload test fixtures use `WALLET_MIN_RING_SIZE` (no magic `ring_size: 16`) + smoke | 5 | **Landed** (`eef017ff`; watching tip **CI `#29905438517`**) |
