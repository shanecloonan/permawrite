...
**Emission / treasury (M5.0â€“M5.30):** default CI runs `mfn-consensus/tests/emission_simulation.rs` (100k-height curve + 10k empty blocks + 512-block storage-proof ledger + validator CLSAG/mixed fee chains including **64-block validator mixed CLSAG+SPoRA (M5.34/B-03)** + liveness-slash/combined-inflow treasury ledgers, including 32/64-block equivocation combined-inflow, prefunded treasury backstop coverage, and 16/32-block no-equivocation PPB combined-inflow coverage). Longer sims, including 96-block validator CLSAG-only, 64/256-block combined-inflow, 64/256/512-block no-equivocation PPB combined-inflow, and 128/512-block equivocation combined-inflow runs, are `#[ignore]` (nightly).
