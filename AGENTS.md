...
**CI gate (2026-08-07):** Claiming **B-282** nineteenth dual settle (docs-only while tip CI `#31144715090` runs on B-281 `27768fba`). Strategic path: L4 -> **B-40** -> **B-13a** -> **B-25**.
...
| **4** Protocol | **B-281** (`27768fba`); **B-280** GREEN `#31142492616` | **B-282** nineteenth dual settle (claim base: `27768fba`) | After land: nineteenth asymmetric pair; after 2 hosts: live **B-32** | Lane 1 CI |
...
| B-282 | Nineteenth dual-slash then dual settle drain (early B-24ec) | 4 | **Claimed** (this commit) — elevates B-273; full CI after `#31144715090` GREEN |
