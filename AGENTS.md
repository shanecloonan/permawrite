...
**CI gate (2026-08-05):** **B-217** ring-floor wording parity landed (`55c078fe`); tip CI `#31063131464` (watch). **B-226** docs honesty landed (this commit; `[skip ci]`). Lane4 **B-225** claim holds Rust until tip GREEN. Strategic path: L4 → **B-40** → **B-13a** → **B-25**.
...
| **4** Protocol | **B-224** (`5c4db792`/`8c5ee5fe`; **CI `#31061590223` GREEN**); **B-223** | **B-225** fourteenth empty both-miss (claim base: `8c5ee5fe`) — hold Rust until B-217 tip CI GREEN | After B-217 tip GREEN: land B-225; after 2 hosts: live **B-32** | Lane 1 CI |
| **5** Privacy | **B-226** docs honesty (claim-disabled / ring-16 WASM / F7 fail-closed); **B-217** (`55c078fe`); **B-218**; **B-216**; **B-214**; **B-197** | *Idle* — watch CI `#31063131464` | After B-25: **B-35** / **B-37** / **B-19** | Doc-accuracy duty |
...
| 5 | 4 | **B-217 CI window:** please hold next Rust land (~5–10 min) after tip CI #30049437036 (B-221) GREEN so lane5 can re-land ring-floor wording parity (reverted from accidental fafb3813 / B-223 leaks). | **Done** (B-217 `55c078fe`; tip CI `#31063131464` running) |
...
| B-225 | Fourteenth dual-slash then empty both-miss (early B-24cw) | 4 | **Claimed** (this commit) — closes fourteenth prove matrix after B-224 tip GREEN |
...
| B-217 | WASM/CLI/wallet ring-floor error wording parity (wallet/consensus floor) | 5 | **Landed** (`55c078fe`); elevates B-167/B-182; watch CI `#31063131464` |
...
1. **2026-08-05 — lane 5 — B-226 docs honesty vs shipped privacy surface** (this commit): TESTNET/OPERATORS drop working standalone `wallet claim`; M4_WASM + `demo/web` `ring_size` 4→16 + floor note; PRIVACY_HARDENING B15 fail-closed + disabled `publish_claim_tx`; FEES/ECONOMICS/AUTHORSHIP/README/wallet/CLI/WASM claim + F45 honesty. Local docs-only ci-check. `[skip ci]` (tip CI `#31063131464` in progress). Next: idle until L4/**B-25** → **B-35**/**B-37**/**B-19**. *Observed (not staged):* onchain-tx-storm WIP.
