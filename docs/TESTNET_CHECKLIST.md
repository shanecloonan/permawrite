...
- [x] **B-22** — TL-8 checkpoint log republished (Path A signer-2; `max_tip_height=4133` + public seed `anchor_peers`; seed offline on VPS only). **Refresh:** **B-137** tip-**5290** (`10eedc1`; entries=48; lag assert OK). **Refresh:** **B-243** tip-**16293**. **Refresh:** **B-249** tip-**16309** (entries=50; F45 soft-repin PASS). **B-250** tall-tip soft-scan auto-delegates unpinned wallets (VPS prove PASS tip~16311). **Refresh:** **B-252** tip-**16321** (entries=51; health lag=0). **Refresh:** **B-256** tip-**16330** (entries=52; health lag=0). **B-258** Path A timer/default lag threshold **8** (was 16). **Refresh:** **B-260** tip-**16341** (entries=53; health lag=0). **Refresh:** **B-264** tip-**16456** (entries=54; outside-in lag OK lag=-1). **Refresh:** **B-267** tip-**16468** (entries=55; outside-in lag OK lag=0). **Refresh:** **B-298** tip-**22437** (entries=84; outside-in OK lag=6; repo had been stuck at 16622). **Refresh:** **B-15 wave115** tip-**22467** (entries=87; outside-in OK lag=1; last_proven 6848→22467).
f2fafe3); **B-244**/**B-245**/**B-255** arm-ready still 1-host NOT READY (B-255 adds p2p-forward hygiene gate; tip=16328).
...
- [ ] **B-40** — First permanence week (arm day-of L4; runbook [`B40_PERMANENCE_WEEK.md`](./B40_PERMANENCE_WEEK.md); **B-13a**/telemetry pre-armed).
